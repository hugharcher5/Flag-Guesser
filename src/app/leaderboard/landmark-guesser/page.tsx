...
export default function LandmarkGuesserLeaderboard() {
  ...
  useEffect(() => {
    fetch("/api/leaderboard?mode=landmark_guesser&limit=50")
      .then((res) => {
      ...
      <div className="w-full max-w-2xl flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-3xl font-bold tracking-tight text-gray-800">
            Landmark Guesser Leaderboard
          </h1>
          <p className="text-sm text-gray-500">
            Top 50 players · sorted by best average distance (lower = better)
          </p>
        </div>
