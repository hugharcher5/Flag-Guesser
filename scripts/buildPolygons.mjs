...
const POLYGON_OVERRIDES = {
  // Monaco: Natural Earth 10m extends ~4 km too far west (to 7.37°E) due to a data error.
  // Replaced with a hand-crafted 16-point polygon tracing the actual border with France
  // and the Mediterranean coast.  Bbox ~7.404–7.441°E, 43.724–43.750°N.
  mc: { type: 'Polygon', coordinates: [[[7.4094,43.7272],[7.4141,43.7248],[7.4194,43.7235],[7.4252,43.7238],[7.4308,43.7255],[7.4361,43.7308],[7.4403,43.7375],[7.441,43.7455],[7.4378,43.7501],[7.4297,43.7499],[7.4195,43.7487],[7.4096,43.7458],[7.4047,43.7411],[7.4036,43.7349],[7.4054,43.7294],[7.4094,43.7272]]] },
  // Vatican City: Natural Earth rounds all vertices to the same longitude, producing
  // geoW≈0 which renders as an empty SVG path.  Replaced with a 12-point polygon
  // tracing the actual Leonine Wall and St. Peter's Square colonnade.
  va: { type: 'Polygon', coordinates: [[[12.4578,41.9024],[12.4584,41.9051],[12.458,41.9073],[12.4558,41.9077],[12.452,41.9075],[12.4466,41.9068],[12.4458,41.9044],[12.4462,41.902],[12.4476,41.9008],[12.4513,41.9002],[12.4548,41.901],[12.4578,41.9024]]] },
  // Nauru: Natural Earth has only 9 vertices (a rough octagon).  Replaced with a
  // 33-point smooth ellipse using the correct NE extremes as semi-axes.
  nr: { type: 'Polygon', coordinates: [[[166.9325,-0.4904],[166.93747,-0.49099],[166.94226,-0.49274],[166.94667,-0.49558],[166.95053,-0.49941],[166.9537,-0.50407],[166.95606,-0.50938],[166.95751,-0.51515],[166.958,-0.52115],[166.95751,-0.52715],[166.95606,-0.53292],[166.9537,-0.53823],[166.95053,-0.54289],[166.94667,-0.54672],[166.94226,-0.54956],[166.93747,-0.55131],[166.9325,-0.5519],[166.92753,-0.55131],[166.92274,-0.54956],[166.91833,-0.54672],[166.91447,-0.54289],[166.9113,-0.53823],[166.90894,-0.53292],[166.90749,-0.52715],[166.907,-0.52115],[166.90749,-0.51515],[166.90894,-0.50938],[166.9113,-0.50407],[166.91447,-0.49941],[166.91833,-0.49558],[166.92274,-0.49274],[166.92753,-0.49099],[166.9325,-0.4904]]] },
  ...
  // Singapore: the previous 120-point polygon extended to 104.129°E (13 km offshore),
  // making the shape look completely wrong.  Replaced with Natural Earth 10m 40-point
  // outline (correct bbox 103.640–104.003°E, 1.264–1.449°N).
  sg: { type: 'Polygon', coordinates: [[[103.960785,1.391099],[103.985688,1.385443],[103.999522,1.380316],[104.003429,1.374172],[103.991873,1.354926],[103.974864,1.334459],[103.954356,1.318101],[103.931895,1.311469],[103.907237,1.308743],[103.887706,1.301256],[103.852712,1.277289],[103.846934,1.271918],[103.844086,1.2685],[103.838878,1.266262],[103.82602,1.264309],[103.801606,1.264797],[103.789561,1.26789],[103.784434,1.273871],[103.77589,1.287584],[103.755138,1.297105],[103.730154,1.302924],[103.708751,1.305243],[103.665294,1.304104],[103.647634,1.308417],[103.640391,1.322252],[103.644705,1.338039],[103.674571,1.380316],[103.678884,1.399237],[103.683849,1.409898],[103.695079,1.421332],[103.708344,1.429389],[103.717947,1.430976],[103.739757,1.428127],[103.762218,1.430976],[103.79005,1.444281],[103.804942,1.448635],[103.831554,1.447089],[103.857188,1.438707],[103.932465,1.401109],[103.960785,1.391099]]] },
};
